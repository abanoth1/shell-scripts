...
USAGE(){
    echo -e " $R USAGE:: sudo sh-24-backup.sh <SOURCE_DIRECTORY> <DESTINATION_DIRECTORY> <DAYS> [OPTIONAL: DAYS AFTER WHICH OLD BACKUPS WILL BE DELETED, DEFAULT IS 14 DAYS]"
    exit 1
}
